...
def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
                 to_vocabulary_size,from_train_data_vocab,to_train_data_vocab, tokenizer=None):
  ...
  # create to vocab
  create_vocabulary(to_vocab_path, to_train_data_vocab, to_vocabulary_size, tokenizer)
  # create from vocab
  create_vocabulary(from_vocab_path, from_train_data_vocab , from_vocabulary_size, tokenizer)
